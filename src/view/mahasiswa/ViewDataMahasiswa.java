...
public class ViewDataMahasiswa extends JFrame {
    ...
    JTextField kolomCari = new JTextField();
    ...
    public ViewDataMahasiswa() {
        ...
        kolomCari.setBounds(20, 8, 435, 24);
        cari.setBounds(463, 8, 60, 24);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (baris != null) {
                    ...
                    */
                    ...
                    mahasiswaTerpilih.setNim(angkatan);
        ...
        cari.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
               if(kolomCari.getText()!=null){
                   controller.searchMahasiswa(kolomCari.getText());
               }else {
